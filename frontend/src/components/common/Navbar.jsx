...
const Navbar = () => {
    ...
    // Removed category-related functionality since categories are no longer used
                            ...
                            <li key={index}>
                                {
                                    link.title === "Catalog" ? (
                                        <Link to="/catalog/all">
                                            <p className={`${matchRoute("/catalog/:catalogName") ? "bg-yellow-25 text-black" : "text-richblack-25"} rounded-xl p-1 px-3 hover:bg-richblack-700 transition-colors duration-200`}>
                                                {link.title}
                                            </p>
                                        </Link>
                                    ) : (
