...
const { validateEmail, validateSignupData, validateLoginData, validateChangePasswordData } = require('../utils/validation');
...
exports.signup = async (req, res) => {
    try {
        ...
        // Comprehensive validation using regex
...
exports.changePassword = async (req, res) => {
    try {
        ...
        // Password match validation is already handled in validateChangePasswordData
